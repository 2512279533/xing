		...
		<view class="u-upload__wrap">
				...
				<view class="u-upload__wrap__preview" v-for="(item, index) in lists" :key="index">
					...
					<view class="u-upload__status" v-if="item.status === 'uploading' || item.status === 'failed'">
						<view class="u-upload__status__icon">
							<u-icon v-if="item.status === 'failed'" name="/static/images/close-circle-white.png"
								color="#ffffff" size="50" />
							<u-loading-icon size="44" mode="circle" color="#ffffff" v-else />
						</view>
						<text v-if="item.message" class="u-upload__status__message">{{ item.message }}</text>
					</view>
					<view class="u-upload__deletable" v-if="item.status !== 'uploading' && deletable"
						@tap.stop="deleteItem(index)">
						<view class="u-upload__deletable__icon">
							<u-icon name="/static/images/close-white.png" color="#ffffff" size="22"></u-icon>
						</view>
					</view>
			...
			<template v-if="isInCount">
				...
				<view v-else class="u-upload__button" :hover-class="!disabled ? 'u-upload__button--hover' : ''"
					...
					<u-icon :name="uploadIcon" size="52" :color="uploadIconColor"></u-icon>
...
<style lang="scss" scoped>
	...
	$u-upload-preview-margin: 0 0 10rpx 10rpx !default;
	...
	$u-upload-deletable-height: 32rpx !default;
	...
	$u-upload-icon-top: 2rpx !default;
	$u-upload-icon-right: 2rpx !default;
	...
	$u-upload-botton-margin: 0 0 10rpx 10rpx !default;
	$u-upload-text-font-size:11px !default;
	$u-upload-text-color:$u-tips-color !default;
	$u-upload-text-margin-top: 2px !default;
