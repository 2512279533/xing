	...
	>
		<view
		    ...
		    :style="{
				...
				borderRadius: shape == 'round' ? '100px' : '4rpx',
		...
		>
			...
			>
				<u-icon
				    name="/static/images/input-clear.png"
				    size="44"
				    color="#ffffff"
...
$u-search-close-bgColor: transparent !default;
$u-search-close-transform: scale(0.82) !default;
$u-search-input-font-size: 30rpx !default;
...
$u-search-action-active-width: 125rpx !default;
$u-search-action-margin-left: 0 !default;
