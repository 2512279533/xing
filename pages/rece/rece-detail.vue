		...
		<!-- #endif -->
				...
				<z-form-select 
			      ...
			      <view v-if="temp=='0'  || RoleID==10">
							...
							<view v-if="temp=='1'||temp=='2'  && RoleID!=10">
									<my-tabbar
									 v-model="type"
									  label="检 具 状 态" 
									  placeholder="-" 
			...
			<!-- #endif -->
			<view class="bottom-block" v-if="temp!=0 && RoleID!=10">
...
<script>
    ...
    import Sub from '../../api/interface/rece.js'
	...
	export default {
		...
		onLoad(options) {
			...
			console.log("sacasca===="+uni.getStorageSync("userInfo").RoleID)
			this.RoleID=uni.getStorageSync("userInfo").RoleID
			uni.request({
